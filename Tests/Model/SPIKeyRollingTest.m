...
- (void)testKeyRolling {
    ...
    SPISecrets *oldSecrets = [[SPISecrets alloc] initWithEncKey:@"11A1162B984FEF626ECC27C659A8B0EEAD5248CA867A6A87BEA72F8A8706109D"
    ...
    XCTAssertEqualObjects(@"0307C53DD0F119A1BC4CE61AA395882FB63BF8FCD0E0D27BBEB0D56AA9B24162", krResult.secrets.encKey);
    XCTAssertEqualObjects(@"E4C3908437C14AC442C925FC8ED536C69FF67080D15FE007D69F8580D73FDF9D", krResult.secrets.hmacKey);
