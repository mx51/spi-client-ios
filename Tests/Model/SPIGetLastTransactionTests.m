...
@interface SPIGetLastTransactionTests : XCTestCase

@end

@implementation SPIGetLastTransactionTests

- (void)testPopulateGetLastTransactionResponse {
