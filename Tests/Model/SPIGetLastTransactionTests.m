...
- (void)testGlt_response_can_be_populated {
    ...
    SPIGetLastTransactionResponse *response =
    [[SPIGetLastTransactionResponse alloc] initWithMessage:msg];
    ...
    XCTAssertTrue([[response getPosRefId]
                   isEqualToString:@"kebab-18-06-2018-00-01-45"]);
    ...
    XCTAssertTrue([[response getBankDateTimeString]
                   isEqualToString:@"18062018000145"]);
