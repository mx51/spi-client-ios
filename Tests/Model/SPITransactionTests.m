...
- (void)testClient_canHandle_purchase_response {
    ...
    // Initiate request
    client.state.status = SPIStatusPairedConnected;
    [client initiatePurchaseTx:@"kebab-18-06-2018-03-44-05" purchaseAmount:10 tipAmount:0 cashoutAmount:0 promptForCashout:false completion:^(SPIInitiateTxResult *result) {
    }];
